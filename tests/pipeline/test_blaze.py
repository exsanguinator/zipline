...
class BlazeToPipelineTestCase(TestCase):
    ...
    def test_id_take_last_in_group(self):
        ...
        input (df):
           ...
           asof_date  timestamp  sid  other  value
        0 2014-01-01 2014-01-01   65      0      0
        0 2014-01-01 2014-01-01   65      1    NaN
        1 2014-01-01 2014-01-01   66    NaN    NaN
        1 2014-01-01 2014-01-01   66    NaN      1
        2 2014-01-01 2014-01-01   67      2    NaN
        2 2014-01-01 2014-01-01   67    NaN    NaN
        3 2014-01-02 2014-01-02   65    NaN    NaN
        3 2014-01-02 2014-01-02   65    NaN      1
        4 2014-01-02 2014-01-02   66    NaN    NaN
        4 2014-01-02 2014-01-02   66      2    NaN
        5 2014-01-02 2014-01-02   67      3      3
        5 2014-01-02 2014-01-02   67      3      3
        6 2014-01-03 2014-01-03   65      2    NaN
        6 2014-01-03 2014-01-03   65      2    NaN
        7 2014-01-03 2014-01-03   66      3      3
        7 2014-01-03 2014-01-03   66    NaN    NaN
        8 2014-01-03 2014-01-03   67    NaN    NaN
        8 2014-01-03 2014-01-03   67    NaN      4
        ...
        df = pd.DataFrame(
            ...
            data=[
                [T('2014-01-01'), T('2014-01-01'),   65,      0,      0],
                [T('2014-01-01'), T('2014-01-01'),   65,      1, np.nan],
                [T('2014-01-01'), T('2014-01-01'),   66, np.nan, np.nan],
                [T('2014-01-01'), T('2014-01-01'),   66, np.nan,      1],
                [T('2014-01-01'), T('2014-01-01'),   67,      2, np.nan],
                [T('2014-01-01'), T('2014-01-01'),   67, np.nan, np.nan],
                [T('2014-01-02'), T('2014-01-02'),   65, np.nan, np.nan],
                [T('2014-01-02'), T('2014-01-02'),   65, np.nan,      1],
                [T('2014-01-02'), T('2014-01-02'),   66, np.nan, np.nan],
                [T('2014-01-02'), T('2014-01-02'),   66,      2, np.nan],
                [T('2014-01-02'), T('2014-01-02'),   67,      3,      3],
                [T('2014-01-02'), T('2014-01-02'),   67,      3,      3],
                [T('2014-01-03'), T('2014-01-03'),   65,      2, np.nan],
                [T('2014-01-03'), T('2014-01-03'),   65,      2, np.nan],
                [T('2014-01-03'), T('2014-01-03'),   66,      3,      3],
                [T('2014-01-03'), T('2014-01-03'),   66, np.nan, np.nan],
                [T('2014-01-03'), T('2014-01-03'),   67, np.nan, np.nan],
                [T('2014-01-03'), T('2014-01-03'),   67, np.nan,      4],
            ],
        )
        fields = OrderedDict(self.dshape.measure.fields)
        fields['other'] = fields['value']
